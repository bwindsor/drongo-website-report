...
class TestAltText(unittest.TestCase):
    ...
    def test_get_caption_from_map(self):
        filename = "day0_1_ben_john_jeremy_chairlift_selfie.JPG"
        captions = {filename: "Ben, John & jeremy on the chairlift"}
        alt_txt = get_image_caption(captions, filename)
        self.assertEqual("Ben, John & jeremy on the chairlift", alt_txt)
